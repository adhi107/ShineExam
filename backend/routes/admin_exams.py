...
def create_exam():
    ...
    exam_doc = {
        ...
        "sections": sections,
        "negativeMarkingScheme": str(payload.get("negativeMarkingScheme") or "quarter").strip(),
        "negativeMarks": float(payload.get("negativeMarks", 0.25) or 0),
        "status": "active",
...
def get_exam(exam_id: str):
    ...
    return jsonify({
        "test": to_jsonable({
            ...
            "negativeMarkingScheme": exam.get("negativeMarkingScheme", "quarter"),
            "negativeMarks": float(exam.get("negativeMarks", 0.25) or 0),
...
def update_exam(exam_id: str):
    ...
    update = {
        ...
        "passingPercentage": passing_percentage,
        "sections": sections,
        "negativeMarkingScheme": str(payload.get("negativeMarkingScheme") or exam.get("negativeMarkingScheme") or "quarter").strip(),
        "negativeMarks": float(payload.get("negativeMarks", exam.get("negativeMarks", 0.25)) or 0),
